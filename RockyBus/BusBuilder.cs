...
namespace RockyBus
{
    public class BusBuilder
    {
        ...
        public IBus Build()
        {
            ...
            if (dependencyResolver != null && poorMansDependencyInjection != null) throw new ArgumentException("Use either dependency injection or add message handler, not both, to register message handlers.");
